...
<body>
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link text-navy" data-widget="pushmenu" href="#" role="button"><i
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown user-menu">
                    ...
                    <ul id="cardUser"
                        class="dropdown-menu dropdown-menu-lg dropdown-menu-right border-0 rounded elevation-2"
        ...
        <aside class="main-sidebar sidebar-light-navy elevation-3">
            ...
            <a href="#" class="brand-link">
                <img
                    src="img/Logo.png" alt="Logo do Hospital Rio Grande"
